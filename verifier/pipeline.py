...
from .models import VerificationResult, PipelineStage
from .config import VerifierConfig
from .normalizer import normalize_email, split_email, normalize_domain
from .syntax_validator import validate_syntax
from .typo_detector import detect_typo
from .dns_validator import validate_dns, check_domain_reachable
...
class VerificationPipeline:
    ...
    def _stage_free_provider(self, result: VerificationResult) -> PipelineStage:
        start = time.monotonic()
        try:
            from .mx_provider import is_free_provider, ProviderType
